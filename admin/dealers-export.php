...
function PopulateSheet($objPHPExcel, $sheetsort, $sheetname) {
	$result = mysql_query("SELECT customer,address,city,state,zip,telephone FROM where_can_i_buy ORDER BY $sheetsort ASC");
	$headings = array("Customer","Address","City","State","Zip Code","Telephone");
  $lastcol = "F";

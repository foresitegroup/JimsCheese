<?php
  ...
  define('DIR_FS_DOCUMENT_ROOT', 'C:/wamp/www/JimsCheese/products/');
  define('DIR_WS_ADMIN', '/JimsCheese/products/admin/');
  define('DIR_FS_ADMIN', 'C:/wamp/www/JimsCheese/products/admin/');
  define('DIR_WS_CATALOG', '/JimsCheese/products/');
